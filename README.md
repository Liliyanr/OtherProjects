...
| [14. План-Факт анализ для Завода Слоистый пластик](https://disk.yandex.ru/i/8OtnRxYhhWRSNQ)| Написать скрипты sql, Создать отчет в Power BI| *Excel, Power BI (DAX), SQL (CTE) |
